...
import com.example.dualiza.databinding.ActivityAdministradoresBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FieldValue
import com.google.firebase.storage.FirebaseStorage
import java.io.ByteArrayOutputStream

class Administradores : AppCompatActivity() {
    lateinit var binding: ActivityAdministradoresBinding
    ...
    private val openCamera =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == RESULT_OK) {
                ...
                binding.btnImagenPerfilAdministrador.setImageBitmap(bitmapAjustado)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdministradoresBinding.inflate(layoutInflater)
        ...
        binding.administradoresToolbar.title = "DUALIZA"
        setSupportActionBar(binding.administradoresToolbar)
        ...
        binding.btnImagenPerfilAdministrador.setOnClickListener(){
