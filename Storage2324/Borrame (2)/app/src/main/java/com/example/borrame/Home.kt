...
//            this.crearCamposArray()
        ...
        binding.btEliminar.setOnClickListener {
            ...
            val id = db.collection("users")
                .whereEqualTo("id",binding.txtEmail.text.toString())
                .get()
...
//                        var us = User(document.get("born") as String,document.get("first") as String,document.get("last") as String,document.get("roles") as ArrayList<Int>)
//                        this.miArray.add(us)
//                        Log.d("Fernando", miArray.toString())
//                    }
//
//                }
...
//                }
//            Log.e("Fernando", "Aunque el código va después de la llamada el ArrayList está vacío: ${miArray.toString()}")
...
//            //Corrutinas 2.
            runBlocking {
                val loquesea : Job = launch(context = Dispatchers.Default) {
...
//                    val results = mutableListOf<String>()
                ...
                loquesea.join() //Esperamos a que el método acabe: https://dzone.com/articles/waiting-for-coroutines
            }
            Log.e(TAG,"----------------")
            for(e in miArray){
